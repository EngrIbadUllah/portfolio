...
const ProjectDetails = () => {
  ...
  const projectUrl = `https://engribadullah.github.io/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Ibad Ullah</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} by Ibad Ullah — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Ibad Ullah`}
        />
        <meta
