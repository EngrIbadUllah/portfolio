...
const TechStack = memo(({ tech }) => (
  <div className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 hover:border-[#6366f1]/50 hover:text-white transition-all duration-300 group">
    <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-[#6366f1] to-[#a855f7] group-hover:scale-125 transition-transform duration-300"></span>
    {tech}
  </div>
));
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Ibad Ullah Software Engineering Student & Frontend Developer</title>
        ...
        <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
          <div className="container mx-auto min-h-screen">
            <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20 py-20 lg:py-0">
              ...
              <div className="w-full py-0 md:py-[10%] sm:py-0 lg:w-1/2 h-[220px] sm:h-[350px] lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-2 sm:mt-0"
